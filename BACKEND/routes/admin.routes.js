...
import { adminLogin, adminLogout, createPoll, deleteVoter, pollList, pollResult, registerVoter, viewVoter, viewVoters, changePassword, forgotPassword } from '../controllers/admin.controller.js';
